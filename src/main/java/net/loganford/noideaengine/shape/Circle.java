...
public class Circle extends Shape {
    ...
    static {
        ShapeIntersectionEngine.addIntersectionHandler(Circle.class, Circle.class, (circle1, circle2) ->
        ...
        ShapeIntersectionEngine.addIntersectionHandler(Circle.class, Line.class, (circle, line) -> {
